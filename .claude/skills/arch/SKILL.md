...
Load [references/checklists.md](references/checklists.md) when doing hands-on work: new table, new API endpoint, new Vue component/view, migration rollback format, API versioning/breaking-change policy, new tenant onboarding, compliance data map, performance checklist. Moved out of this file 2026-09 to stay under the 500-line guidance — load on demand, not on every invocation.
...
| File | Purpose |
|---|---|
| [references/checklists.md](references/checklists.md) | New table/endpoint/component checklists, migration rollback format, API versioning policy, tenant onboarding, compliance data map, performance checklist |
