...
brand/
  ...
  logos/
    ...
    pwa/
      pwa-badge.png    "PWA" badge under the login card – white P/A, lavender (#C4B5FD) W,
                       made for the teal login background (NEO-12; guarded by AuthView.pwaBadge.spec.ts).
