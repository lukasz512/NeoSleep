  ...
  async function load(): Promise<AppConfig> {
    ...
    try {
      ...
      config.value = {
        ...
        primary_color_dark: normalizeHex((data as Partial<AppConfig>).primary_color_dark) ?? defaults.primary_color_dark,
        secondary_color_dark: normalizeHex((data as Partial<AppConfig>).secondary_color_dark) ?? defaults.secondary_color_dark,
    ...
    try {
      ...
      if (data && typeof data === "object" && "primary_color" in data) {
        config.value = {
          ...
          primary_color_dark: normalizeHex((data as AppConfig).primary_color_dark) ?? (data as AppConfig).primary_color_dark ?? defaults.primary_color_dark,
          secondary_color_dark: normalizeHex((data as AppConfig).secondary_color_dark) ?? (data as AppConfig).secondary_color_dark ?? defaults.secondary_color_dark,
