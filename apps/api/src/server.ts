...
import { internalPdfRenderCheckRouter } from "./routes/internal-pdf-render-check.js"; // TEMPORARY — delete with the route file once the Render PDF-rendering check is verified
...
app.use("/api/v1", internalPdfRenderCheckRouter); // TEMPORARY — see import comment above
