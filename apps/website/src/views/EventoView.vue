<template>
  ...
  <!-- ── Manifesto ─────────────────────────────────────────────────────────── -->
  <section ref="manifestoRef" class="home-section ev-manifesto home-reveal" :class="{ 'home-reveal--visible': manifestoVisible }">
      ...
      <div class="ev-manifesto__grid">
        <div v-for="p in pillars" :key="p.title" class="ev-pillar">
          <div class="ev-pillar__img-wrap">
            <LazyImg :src="p.img" :alt="p.title" class="ev-pillar__img" />
          </div>
  ...
  <section ref="splitRef" class="ev-split home-reveal" :class="{ 'home-reveal--visible': splitVisible }">
  ...
  <section ref="sistemaRef" class="home-section ev-sistema home-reveal" :class="{ 'home-reveal--visible': sistemaVisible }">
    <div class="page-container">
  ...
  <!-- ── Ponentes ───────────────────────────────────────────────────────────── -->
  <section id="ponentes" ref="ponentesRef" class="home-section ev-ponentes home-reveal" :class="{ 'home-reveal--visible': ponentesVisible }">
    <div class="page-container">
      ...
      <div class="ev-speakers">
        ...
        >
          <PersonAvatar
            ...
            :fallback-color="s.color"
            class="ev-speaker__avatar"
          />
      ...
      >
        <div class="ev-modal">
          ...
          <div class="ev-modal__header">
            <PersonAvatar
              :photo="active.photo"
              :alt="active.name ?? active.specialty"
              :fallback-color="active.color"
              class="ev-modal__avatar"
            />
            <div>
  ...
  <!-- ── Cierre exclusivo ───────────────────────────────────────────────────── -->
  <section ref="cierreRef" class="ev-cierre home-reveal" :class="{ 'home-reveal--visible': cierreVisible }">
  ...
  <!-- ── Patrocinadores ───────────────────────────────────────────────────── -->
  <section ref="patrocinRef" class="home-section ev-patrocin home-reveal" :class="{ 'home-reveal--visible': patrocinVisible }">
        ...
        <div class="ev-modal ev-sponsor-modal" style="font-family: var(--website-font-sans);">
          ...
          <template v-if="sponsorModal === 'orthoapnea'">
            <div class="ev-sponsor-modal__header">
              <LazyImg src="/images/noa.png" alt="NOA by OrthoApnea" class="ev-sponsor-modal__logo ev-sponsor-modal__logo--product" />
            </div>
          ...
          <template v-else-if="sponsorModal === 'biologix'">
            <div class="ev-sponsor-modal__header">
              <LazyImg src="/images/biologix.png" alt="Biologix" class="ev-sponsor-modal__logo ev-sponsor-modal__logo--product" />
            </div>
  ...
  <!-- ── El Lugar / Sede ───────────────────────────────────────────────────── -->
  <section ref="sedeRef" class="ev-sede home-reveal" :class="{ 'home-reveal--visible': sedeVisible }">
    <div class="page-container ev-sede__inner">
      ...
      <button class="ev-sede__preview" @click="sedeModalOpen = true" aria-label="Ver Soho House Mexico City">
        <LazyImg src="/images/soho-house-cdmx.jpeg" alt="Soho House Mexico City" class="ev-sede__preview-img" />
      ...
      >
        <div class="ev-sede-modal">
          ...
          <div class="ev-sede-modal__img-wrap">
            <LazyImg src="/images/soho-house-cdmx-2.jpeg" alt="Soho House Mexico City" class="ev-sede-modal__img" />
          </div>
  ...
  <!-- ── Contacto ─────────────────────────────────────────────────────────── -->
  <section id="contacto" ref="contactoRef" class="ev-contacto home-reveal" :class="{ 'home-reveal--visible': contactoVisible }">
...
import { LazyImg, PersonAvatar } from "@ui";
import { useRevealGroup } from "@shared/composables/useReveal";
...
const [manifestoVisible, splitVisible, sistemaVisible, ponentesVisible, patrocinVisible, cierreVisible, sedeVisible, contactoVisible] =
  useRevealGroup([manifestoRef, splitRef, sistemaRef, ponentesRef, patrocinRef, cierreRef, sedeRef, contactoRef], 0.08);
...
.ev-speaker__avatar :deep(svg) {
  width: 100%;
  height: 100%;
}
.ev-speaker__avatar :deep(img) {
  width: 100%;
  height: 100%;
  object-fit: cover;
...
.ev-modal__avatar :deep(svg) {
  width: 100%;
  height: 100%;
}
.ev-modal__avatar :deep(img) {
  width: 100%;
  height: 100%;
  object-fit: cover;
  object-position: center top;
