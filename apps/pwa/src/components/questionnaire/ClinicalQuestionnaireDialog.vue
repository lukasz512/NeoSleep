<template>
  <VDialog :model-value="modelValue" :max-width="kind === 'stop_bang' ? 880 : 640" scrollable :transition="originDialogTransition" @update:model-value="emit('update:modelValue', $event)">
