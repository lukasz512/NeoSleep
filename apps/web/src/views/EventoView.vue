      ...
      <div class="ev-speakers">
        ...
        >
          <div class="ev-speaker__avatar" :style="s.photo ? {} : { background: s.color }">
            <LazyImg v-if="s.photo" :src="s.photo" :alt="s.name ?? s.specialty" class="ev-speaker__photo" />
        ...
        <div class="ev-modal">
          ...
          <div class="ev-modal__header">
            <div class="ev-modal__avatar" :style="active.photo ? {} : { background: active.color }">
              <LazyImg v-if="active.photo" :src="active.photo" :alt="active.name ?? active.specialty" class="ev-modal__photo" />
  ...
  <section ref="sedeRef" class="ev-sede home-reveal">
    <div class="page-container ev-sede__inner">
      ...
      <button class="ev-sede__preview" @click="sedeModalOpen = true" aria-label="Ver Terraza Cabuya, Hotel Andaz Condesa">
        <LazyImg src="/images/hotel-andaz-condesa.jpeg" alt="Hotel Andaz Condesa" class="ev-sede__preview-img" />
      ...
      >
        <div class="ev-sede-modal">
          ...
          <div class="ev-sede-modal__img-wrap">
            <LazyImg src="/images/hotel-andaz-condesa-2.jpeg" alt="Hotel Andaz Condesa" class="ev-sede-modal__img" />
          </div>
...
/* ── Lazy image loading ───────────────────────────────────────────────────── */
/* Fade/blur-in handled by the shared LazyImg component (@ui) — only the loading
   shimmer background on the wrapper elements stays local to this view. */
