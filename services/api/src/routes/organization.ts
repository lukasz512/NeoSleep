...
import { getOrganizationPaginated, getOrganizationById, type GetOrganizationFilters } from "../db.js";
...
organizationRouter.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    const { rows, total } = await getOrganizationPaginated(filters, page, limit, sortBy, sortOrder);
